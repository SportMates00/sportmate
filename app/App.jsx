  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={screenOptions}>
        ...
        <Stack.Screen name="ShareProfile" component={ShareProfile} options={{ title: '' }} />
        <Stack.Screen name="ShareLink" component={ShareLink} options={{ title: '' }} />
